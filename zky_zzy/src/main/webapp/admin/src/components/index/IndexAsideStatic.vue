	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo>.el-menu-item:hover {
						color: #fff;
						background: url(/zky_zzy/admin/dist/img/menu_tab.png) center center/cover no-repeat;
					}
		...
		.el-menu-vertical-demo .el-submenu /deep/ .el-menu .el-menu-item {
						padding: 0 40px;
						color: #A2A2A2;
						background: linear-gradient(90deg, #F9F9F9 0%, #F9F9F9 3%,#ff9912 3%, #ff9912 5%,#F9F9F9 5%,  #F9F9F9 100%);
						border-color: #fff;
		...
		.el-menu-vertical-demo .el-submenu /deep/ .el-menu .el-menu-item:hover {
						padding: 0 40px;
						color: #fff;
						background: linear-gradient(90deg, #ff9912 0%, #ff9912 3%, #F9F9F9 3%, #F9F9F9 5%,#ff9912 5%,  #ff9912 100%);
						line-height: 50px;
						height: 50px;
					}
